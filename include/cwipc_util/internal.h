...
_CWIPC_UTIL_EXPORT int _cwipc_register_capturer(const char *name, bool isCamera, _cwipc_functype_count_devices *countFunc, _cwipc_func_capturer_factory *factoryFunc);
