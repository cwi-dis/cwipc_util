...
class SimulatecamsFilter(cwipc_abstract_filter):
    ...
    def __init__(self, ncamera : int, hard : Optional[bool] = False):
    ...
    def filter(self, pc : cwipc_wrapper) -> cwipc_wrapper:
        ...
        for i in range(count):
            ...
            if self.hard:
                ...
                weight_0 = dot_products[camera_index_0]
                weight_1 = dot_products[camera_index_1]
                if numpy.random.uniform(0, weight_0 + weight_1) < weight_0:
