...
setup(
    ...
    description='Python interface to cwipc libraries (ctypes-based)',  # Optional
    ...
    install_requires=['numpy', 'open3d', 'Pillow', 'opencv-python'],
    ...
    entry_points={  # Optional
        'console_scripts': [
            ...
            'cwipc_tilecolor=cwipc.scripts.cwipc_tilecolor:main',
        ],
    },
